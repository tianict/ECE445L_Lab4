...
void static commonInit(const uint8_t *cmdList) {
    ...
    GPIOConfig_t GPIOconfigs[5] = {
        {PIN_A2, GPIO_PULL_DOWN, true,  2, false, GPIO_DRIVE_2MA, false},
        {PIN_A3, GPIO_PULL_DOWN, true,  2, false, GPIO_DRIVE_2MA, false},
        {PIN_A5, GPIO_PULL_DOWN, true,  0, false, GPIO_DRIVE_2MA, false},
        {PIN_A6, GPIO_PULL_DOWN, true,  0, false, GPIO_DRIVE_2MA, false},
        {PIN_A7, GPIO_PULL_DOWN, true,  0, false, GPIO_DRIVE_2MA, false}
    };
    ...
    GPIOconfigs[2].alternateFunction = 2;
